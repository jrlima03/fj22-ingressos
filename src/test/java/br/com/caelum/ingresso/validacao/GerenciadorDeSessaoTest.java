...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garanteQueNaoDevePermirtirSessaoNoMesmoHorario() {
	...
	@Test
	public void garanteQueNaoDevePermirtirSessoesTerminandoDentroDoHorarioDeUmaSessaoJaExistente() {
		
		List<Sessao> sessaos = Arrays.asList(sessaoDasDez);
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().minusHours(1), rogueOne, sala3D);
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessaos);
