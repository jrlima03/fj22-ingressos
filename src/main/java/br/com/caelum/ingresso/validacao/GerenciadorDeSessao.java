...
public class GerenciadorDeSessao {
	...
	public boolean cabe(Sessao sessaoNova) {
		...
		return sessoesDaSala.stream().noneMatch(sesssaoExistente -> horarioIsConflitante(sesssaoExistente, sessaoNova));
	}
	...
	private boolean horarioIsConflitante(Sessao sesssaoExistente, Sessao sessaoNova) {

		LocalDateTime inicioSessaoExistente = getInicioSessaoComDiaDeHoje(sesssaoExistente);
		LocalDateTime terminoSessaoExistente = getTerminoSessaoComDiaDeHoje(sesssaoExistente);
